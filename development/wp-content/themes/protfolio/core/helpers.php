 ...
 * @return string
 **/
function portfolio_get_theme_asset($asset) {
 ...
 * @param bool $displayTitleLeft displays the page heading left or right of the title
 * @return string
 **/
function portfolio_get_title($separator = '•', $displayTitleLeft = true) {
    $separator = ' ' . $separator . ' ';
